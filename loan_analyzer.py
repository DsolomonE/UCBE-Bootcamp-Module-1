coding: utf-8 #the following error message appears when I run the code: NameError: name 'utf' is not defined
import csv
...
avg_loans2 = sum(loan_costs) / (len( loan_costs))
print(avg_loans2)
...
if present_value >= 500:
    ...
    print("the loand is too expensive and not worth the price.")
...
remaining_months = new_loan.get("remaining_months", 12)
...
Calc_present_value(1000, 9, annual_discount_rate)  #call function just created.



# @TODO: Use the function to calculate the present value of the new loan given below.
#    Use an `annual_discount_rate` of 0.2 for this new loan calculation.
print(Calc_present_value(future_value, remaining_months, annual_discount_rate))
...
def write_to_csv(inexpensive_loans):
    with open('inexpensive_loans.csv', 'w', newline='') as csvfile:
        ...
        for row in inexpensive_loans:
            csvwriter.writerows(str(row))
    print(write_to_csv(inexpensive_loans))

write_to_csv(inexpensive_loans) #_csv.Error: iterable expected, not int
